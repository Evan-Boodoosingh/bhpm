...
export function Hero({ onExploreClick }: HeroProps) {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 text-center opacity-0 scroll-animate">
        ...
        <p className="text-xl md:text-2xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed">
          Discover exceptional homes and unparalleled service in Boston's most
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            ...
            className="text-white hover:text-white active:text-white backdrop-blur-xl px-8 py-6 text-lg rounded-2xl hover:opacity-90"
            onMouseEnter={(e) => {
